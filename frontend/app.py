...
/* FIX: reset the inner BaseWeb textarea's own border/outline/box-shadow so it
   doesn't render its own (often red, focus-state) border on top of the pill
   border above — that mismatch is what produced the doubled outline look. */
div[data-testid="stChatInput"] textarea,
div[data-testid="stChatInput"] [data-baseweb="textarea"] {
    background-color: transparent !important;
